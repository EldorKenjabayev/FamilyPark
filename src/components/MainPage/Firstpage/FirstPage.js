  ...
  return (
    ...
    <Box sx={{
      ...
      <Box>
        ...
        > 
          <Box className="firstTitle-Text" sx={{
            width:'100%'
          }}>
            <Box>
              <h1 className="FirstTitle">
                <span className="FirstTitleOne">{t("Firstpage.FirstTitleOne")}</span>
                <br />
                <span className="FirstTitleTwo">{t("Firstpage.FirstTitleTwo")}</span>
              </h1>
            </Box>
          </Box>
          <Box>   
